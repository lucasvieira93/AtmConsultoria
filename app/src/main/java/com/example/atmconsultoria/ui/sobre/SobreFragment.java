...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View aboutPage = new AboutPage(getActivity())
                ...
                .addGroup("Contato:")
                .addEmail("lvieirastos@gmail.com")

                .addGroup("Redes Sociais:")
                .addFacebook("oi.lucasvieira", "Facebook")
                .addInstagram("oi.lucasvieira", "Instagram")
                .addGitHub("lucasvieira93", "Github")
                .addYoutube("UCiD9-TQyiv-89RTZ7HBLaEQ", "Youtube")
                .addTwitter(null, "Twitter")
